...
buildConfig {
    ...
    val photographeAPIKEy = localProperties.getProperty("photographer.api.key") ?: ""

    println("photographeAPIKEy chargée : $photographeAPIKEy")

    // Crée le champ pour tous les targets (Android, iOS, Desktop)
    buildConfigField("String", "PHOTOGRAPHER_API_KEY", "\"$photographeAPIKEy\"")
}
...
android {
    namespace = "com.example.a02_kmp_m1_sopra"
    compileSdk = libs.versions.android.compileSdk.get().toInt()

    defaultConfig {
        applicationId = "com.example.a02_kmp_m1_sopra"
...
compose.desktop {
    application {
        mainClass = "com.example.a02_kmp_m1_sopra.MainKt"
...
sqldelight {
    databases {
        create("MyDatabase") { //Nom de la classe qui sera générée pour représenter votre base
            ...
            packageName.set("com.example.a02_kmp_m1_sopra.db")
        }
    }
    linkSqlite.set(true)
}
